...
EOT;
    ...
    public function testPHPMailerSendExceptionCoverage() {
        $script = <<<'EOT'
<?php
// Mock PHPMailer
namespace PHPMailer\PHPMailer {
...
EOT;
        ...
        $temp_file = __DIR__ . '/../temp_test_enviar_alertas_send.php';
        file_put_contents($temp_file, $script);
        ...
        $this->assertTrue(
            ...
            "Output should contain the send exception error message. Got: " . $output_str
        );
    }
}
